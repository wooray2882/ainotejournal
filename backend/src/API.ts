...
export type GenerateTitleFromContentMutationVariables = {
  content: string,
};

export type GenerateTitleFromContentMutation = {
  generateTitleFromContent?: string | null,
};

export type ExpandContentMutationVariables = {
  content: string,
};

export type ExpandContentMutation = {
